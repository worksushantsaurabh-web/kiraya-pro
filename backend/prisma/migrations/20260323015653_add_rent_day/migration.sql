...
INSERT INTO "new_Tenant" ("createdAt", "deposit", "email", "hometown", "id", "idProofUrl", "isActive", "landlordId", "leaseEnd", "leaseStart", "name", "phone", "propertyId", "rentAmount", "updatedAt", "userId") SELECT "createdAt", "deposit", "email", "hometown", "id", "idProofUrl", "isActive", "landlordId", "leaseEnd", "leaseStart", "name", "phone", "propertyId", "rentAmount", "updatedAt", "userId" FROM "Tenant";
DROP TABLE "Tenant";
